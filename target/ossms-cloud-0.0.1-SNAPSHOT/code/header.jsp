...
pageEncoding="UTF-8"%> <%@ page import="staff.model.*" %> 
...
<html lang="en">
  <head>
    ...
    <title>SUPRA</title>
    <link rel="icon" href="${pageContext.request.contextPath}/images/supra_logo_temp.png" type="image/png" />
    <!-- NProgress -->
  ...
  <body class="nav-md">
    <div class="container body">
          ...
          <div class="left_col scroll-view">
            <div class="navbar nav_title hidden-print" style="border: 0">
              <div class="rowMenu logo_border">
                <a href="request_dashboard.html" class="site_title"
                  ><span class="rockwell-font">SUPRA </span></a
                >
                <a href="request_dashboard.html"
                  ><img
                    src="${pageContext.request.contextPath}/images/logo_mdt_baru_1.png"
                    height="50"
            ...
            <div class="username-background hidden-print">
              <div class="hidden-print username_frame">
                <h7 class="name-text"> <%= staff.getStaffname() %> </h7>
              </div>
            </div>
            <!-- sidebar menu -->
            <div
              ...
              style="font-weight: normal; color: black !important"
            >
              <div class="menu_section">
                <ul class="nav side-menu">
                  <!-- Home menu item -->
                  <c:if test="${sessionScope.staff.staffrole == 'SUPERADMIN'}">
                  <li>
                    <a href="${pageContext.request.contextPath}/StaffController?action=list"
                      ><i class="fa fa-user"></i
                      ><strong>TETAPAN PENGGUNA</strong></a
                    >
                  </li>
                  </c:if>
                  <li>
                    <a
                      ><i class="fa fa-home"></i> <strong>PERMINTAAN</strong>
                      <span class="fa fa-chevron-down"></span
                    ></a>
                    <ul class="nav child_menu">
                      <li>
                        <a href="${pageContext.request.contextPath}/RequestController?action=list"
                          ><strong>Semua Permintaan</strong></a
                        >
                      </li>
                      <li>
                        <a href="${pageContext.request.contextPath}/RequestController?action=addForm"><strong>Borang</strong></a>
                      </li>
                    </ul>
                  </li>
				<c:if test="${sessionScope.staff.staffrole != 'BIASA'}">
                  <li>
                    <a href="${pageContext.request.contextPath}/RequestController?action=report"
                      ><i class="fa fa-bar-chart"></i
                      ><strong>LAPORAN</strong></a
                    >
                  </li>
                  </c:if>
                  <c:if test="${sessionScope.staff.staffrole == 'SUPERADMIN'}">
                  <li>
                    <a
                      ><i class="fa fa-cogs"></i><strong>TETAPAN</strong
                      ><span class="fa fa-chevron-down"></span
                    ></a>
                    <ul class="nav child_menu">
                      <li>
                        <a
                          href="${pageContext.request.contextPath}/ItemController?action=list"
                          ><strong>Barang</strong></a
                        >
                      </li>

                      <li>
                        <a href="${pageContext.request.contextPath}/DepartmentController?action=list"
                          ><strong>Jabatan</strong></a
                        >
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a href="${pageContext.request.contextPath}/ItemController?action=list"
                      ><i class="fa fa-archive"></i><strong>BARANG</strong></a
                    >
                  </li>

                  <!--
                <li>
                  <a href="manual_pengguna.html"><i class="fa fa-book"></i><strong>MANUAL PENGGUNA</strong></a>
                </li>
                --></ul>
              </div>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li>
                      <a href="${pageContext.request.contextPath}/StaffController?action=ownProfile"
                        ><i class="fa fa-user pull-right"></i> Profil</a
                      >
                    </li>
                    <li>
                      <a href="${pageContext.request.contextPath}/LogoutController"
                        ><i class="fa fa-sign-out pull-right"></i>Log Keluar</a
                      >
                    </li>
                  </ul>
                </li>
      ...
      <script src="${pageContext.request.contextPath}/build/js/custom.js"></script>
      <!-- iCheck -->
      <script src="${pageContext.request.contextPath}/vendors/iCheck/icheck.min.js"></script>
      <!-- Datatables -->
      ...
      <!--export excel -->
      <script src="${pageContext.request.contextPath}/vendors/exportxlxs/dist/xlsx.full.min.js"></script>
      <!-- report html to pdf  -->
      <script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.2/html2pdf.bundle.min.js"></script>
      <!-- report html table to pdf using jsPDF - autotable  -->
      <script src="${pageContext.request.contextPath}/vendors/exceljs/dist/exceljs.min.js"></script>
      <link
	...
	<%
		String alert = (String) request.getParameter("login");
	...
	<%
		String alert2 = (String) request.getParameter("alert");
	if ("addreq".equals(alert)) {
	%>
			<script>
				alert("Permintaan berjaya dihantar");
			</script>
	<%
		}else if ("editreq".equals(alert2)) {
	%>
	...
	<%
		}else if ("approvereq".equals(alert2)) {
	%>
	
			<script>
				alert("Permintaan diluluskan");
			</script>
	<%
		}else if ("rejectreq".equals(alert2)) {
	%>
	...
	<%
		}else if ("completereq".equals(alert2)) {
	%>
	
			<script>
				alert("Permintaan selesai");
			</script>
	<%
		}else if ("additem".equals(alert2)) {
	%>
	...
	<%
		}else if ("edititem".equals(alert2)) {
	%>
	...
	<%
		}else if ("adddept".equals(alert2)) {
	%>
	
			<script>
				alert("Jabatan berjaya ditambah");
			</script>
	<%
		}else if ("editdept".equals(alert2)) {
	%>
			
			<script>
				alert("Jabatan berjaya dikemaskini");
			</script>
	<%
		}else if ("addstaff".equals(alert2)) {
	%>
	...
	<%
		}else if ("editstaff".equals(alert2)) {
	%>
	...
	<%
		}else if ("changePassword".equals(alert2)) {
	%>
	...
	<%
		}else if ("resetPassword".equals(alert2)) {
	%>
			
			<script>
				alert("Kata laluan berjaya di set semula");
			</script>
	<%
		}else if ("delreq".equals(alert2)) {
	%>
			
			<script>
				alert("Permintaan berjaya dipadam");
			</script>
	<%
		}
